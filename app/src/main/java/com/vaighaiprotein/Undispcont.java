...
public class Undispcont extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.undispcont);			
	...
	private void displayData() {
		...
		DisplayAdapter disadpt = new DisplayAdapter(Undispcont.this,userId,Disp_Qty  ,disp_packtype,disp_contno,Disp_docdate);
